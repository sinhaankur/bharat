...
export default async function StudyPage({ params }: { params: Promise<{ slug: string }> }) {
  ...
  return (
    <>
      ...
      <style>{`
        .st { --st-gold: #cc8900; --st-maroon: #9e3b2e; background: #efe3cc; color: #2a2018; max-width: 960px; margin: 0 auto; font-family: var(--font-ui); }
        ...
        .st-em { font-family: var(--font-italic); color: #c8664a; font-weight: 400; }
        .st-lead { font: 400 14px/1.65 var(--font-ui); color: #4a3d30; margin: 0; text-align: justify; max-width: 640px; }
        ...
        .st-map { position: relative; margin: 20px 24px 0; height: 230px; background: #d8f0f0; border: 1px solid var(--line); display: flex; align-items: center; justify-content: center; }
        ...
        .st-legend { position: absolute; bottom: 12px; left: 14px; display: flex; gap: 10px; flex-wrap: wrap; font: 500 10.5px var(--font-ui); color: #4a3d30; }
        .st-dot { display: inline-block; width: 9px; height: 9px; border-radius: 50%; margin-right: 4px; }
        .st-callout { margin: 22px 24px; border: 1px solid rgba(158,59,46,.4); border-left: 5px solid var(--st-maroon); background: #f5e8da; padding: 18px 22px; }
        ...
        .st-callout-q { border-left: 3px solid rgba(42,32,24,.4); padding-left: 14px; font: italic 400 16px/1.55 var(--font-italic); color: #3a2c20; }
        .st-floral { display: block; width: calc(100% - 48px); margin: 0 24px 18px; color: #a8794a; }
