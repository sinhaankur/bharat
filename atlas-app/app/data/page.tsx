...
const TIER_STYLE: Record<string, React.CSSProperties> = {
  T1: { background: '#f7ecd2', color: '#a06b00' },
  T2: { background: '#ece9e2', color: '#3a3630' },
  T4: { border: '1px solid #cc8900', color: '#a06b00' },
  GAP: { border: '1px solid #c3bcb2', color: '#6b665e' },
}
  ...
  return (
    <>
      ...
      <main className="dt">
        ...
        {ROWS.map((r, i) => (
          <div key={i} className="dt-row" style={{ borderBottom: i < ROWS.length - 1 ? '1px solid #ece9e2' : undefined }}>
            <span style={r.italicFigure ? { color: '#6b665e' } : undefined}>{r.figure}</span>
      ...
      <style>{`
        .dt { background: #f6f5f1; color: #1a1917; max-width: 680px; margin: 0 auto; font-family: var(--font-ui); }
        ...
        .dt-thead { font: 600 9.5px var(--font-mono); letter-spacing: .12em; color: #6b665e; border-bottom: 2px solid #262320; }
