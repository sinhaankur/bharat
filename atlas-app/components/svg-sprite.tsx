      ...
      <svg width="0" height="0" style={{ position: 'absolute' }} aria-hidden="true">
        <defs>
          ...
          <pattern id="jali" width="60" height="60" patternUnits="userSpaceOnUse">
            <g fill="none" stroke="#bab6b6" strokeWidth="1.1" opacity="0.14">
          ...
          <pattern id="jali-dark" width="60" height="60" patternUnits="userSpaceOnUse">
            <g fill="none" stroke="#ec3013" strokeWidth="1" opacity="0.1">
              <path d="M30 6 L38 22 L54 30 L38 38 L30 54 L22 38 L6 30 L22 22 Z" />
              <rect x="14" y="14" width="32" height="32" transform="rotate(45 30 30)" />
              <circle cx="30" cy="30" r="6" />
            </g>
          ...
          <pattern id="floral" width="40" height="22" patternUnits="userSpaceOnUse">
            <g fill="none" stroke="#bab6b6" strokeWidth="1.3">
              <path d="M0 11 C 8 3, 12 3, 20 11 S 32 19, 40 11" />
              <path d="M10 7 c -3 -4, 3 -4, 0 0" fill="#bab6b6" />
              <path d="M30 15 c -3 4, 3 4, 0 0" fill="#bab6b6" />
              <circle cx="20" cy="11" r="2" fill="#bab6b6" />
            </g>
          </pattern>
          ...
          {/* lotus bell — the pillar base capital */}
          <symbol id="i-bell" viewBox="0 0 32 32"><g fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round"><path d="M8 8 C8 16 10 21 16 21 C22 21 24 16 24 8" /><path d="M12 8 C12 15 13.5 20 16 21 M20 8 C20 15 18.5 20 16 21" /><path d="M6 6.5 H26" /><path d="M11 24.5 H21 M13 27 H19" /></g></symbol>

          {/* four capital animals — the compass */}
          <symbol id="i-elephant" viewBox="0 0 32 32"><g fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round"><path d="M7 26 V17 C7 11 11 8 16 8 C21 8 25 11 25 15 C25 18 24 19 24 21 C24 23 25 24 27 24" /><path d="M25 15 C27 15 28 14 28 12" /><path d="M11 26 V20 M15 26 V21 M19 26 V21" /><path d="M22 13 h.1" strokeWidth="2.4" strokeLinecap="round" /></g></symbol>
          <symbol id="i-bull" viewBox="0 0 32 32"><g fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round"><path d="M6 26 V18 C6 13 9 11 12 11 C13 8.5 16 8 18 9 C20 8 23 9 23 12 C25 12 27 14 27 17 V26" /><path d="M12 11 C11 9 11 7 12.5 5.5 M18 9 C19 7.5 21 7 22.5 8" /><path d="M10 26 V20 M23 26 V20" /></g></symbol>
          <symbol id="i-horse" viewBox="0 0 32 32"><g fill="none" stroke="currentColor" strokeWidth="1.6" strokeLinejoin="round"><path d="M7 26 V18 C7 14 10 12 14 12 L20 8 L22 4 L25 8 C27 9 27 12 25 13 L23 14 V26" /><path d="M20 8 C18 6.5 16 6.5 15 8" /><path d="M11 26 V19 M19 26 V19" /></g></symbol>

          {/* punch-marked karshapana coin symbols */}
          <symbol id="i-sixarm" viewBox="0 0 32 32"><g fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinecap="round"><circle cx="16" cy="16" r="3.2" /><path d="M16 12.8 V5.5" transform="rotate(0 16 16)" /><path d="M16 12.8 V5.5" transform="rotate(60 16 16)" /><path d="M16 12.8 V5.5" transform="rotate(120 16 16)" /><path d="M16 12.8 V5.5" transform="rotate(180 16 16)" /><path d="M16 12.8 V5.5" transform="rotate(240 16 16)" /><path d="M16 12.8 V5.5" transform="rotate(300 16 16)" /><circle cx="16" cy="4" r="1.7" /><circle cx="26.4" cy="10" r="1.7" /><circle cx="26.4" cy="22" r="1.7" /><circle cx="16" cy="28" r="1.7" /><circle cx="5.6" cy="22" r="1.7" /><circle cx="5.6" cy="10" r="1.7" /></g></symbol>
          <symbol id="i-chaitya" viewBox="0 0 32 32"><g fill="none" stroke="currentColor" strokeWidth="1.5" strokeLinejoin="round"><path d="M10 25 C10 21 12.5 18.5 16 18.5 C19.5 18.5 22 21 22 25 Z" /><path d="M4 25 C4 21.5 6.5 19.5 9.5 19.5 M28 25 C28 21.5 25.5 19.5 22.5 19.5" /><path d="M12.5 18 C12.5 14 14 11.5 16 10 C18 11.5 19.5 14 19.5 18" /><path d="M16 10 V6.5 M13.5 6.5 H18.5" /><path d="M3 27.5 H29" /></g></symbol>
        </defs>
      </svg>
    </>
  )
